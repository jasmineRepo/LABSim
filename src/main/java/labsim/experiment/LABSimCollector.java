...
import labsim.data.filters.FlexibleInLabourSupplyFilter;
import labsim.model.BenefitUnit;
import labsim.model.enums.Quintiles;
...
import static labsim.model.Person.DoublesVariables.GrossLabourIncomeMonthly;
...
//	@GUIparameter(description="Calculate the Gini coefficients of income (also displayed in charts)")
	private boolean calculateGiniCoefficients = true;
