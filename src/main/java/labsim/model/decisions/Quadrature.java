...
public class Quadrature {
    ...
    public Quadrature(int nn) {
        ...
        int jj;
        double eps = 1.0E-14;
        double pim4 = Math.pow(3.1415926535897932384626433, -0.25);
        double zz, zz1, p1, p2, p3, pp, weight_sum;
        zz = 0;
        int maxit = 10;
        ...
        for (int ii = 0; ii<nn; ii++) {
            ...
            weights[ii] = weights[ii] / weight_sum;             // this line controls for 1/sqrt(pi) in weight function
        }
    }
}
